**You’ve come a long way, and it's time to show it.** This is your final project and a chance to use all we've learned over the previous weeks.

**Remember:** simple code is stable code, so always favour refactoring and bug fixing over adding more functionality.

Be smart about how you plan, limit your project scope to be achievable (in terms of functionality) and focus on quality rather than quantity.
...
You must:
* **Sign Off Requirements** An ERD diagram to show the relationships that exist between your models and a basic front-end wireframe/plan of how you will consume and display the data
* **Build a full-stack application** by making your own backend and your own front-end
* **Use a PYTHON FLASK API** to serve your data from a Postgres SQL database
